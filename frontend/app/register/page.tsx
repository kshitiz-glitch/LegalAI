  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (!user) throw new Error("Registration failed — no user data");
    ...
    [email, password, fullName, setAuth, router]
  );
        ...
        <div className="relative flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-base text-white/50 max-w-md leading-relaxed">
              Join legal professionals who use AI to review contracts faster,
              catch hidden risks, and negotiate smarter.
            </p>
          </div>
        ...
        <div className="w-full max-w-sm animate-fade-in">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Get started with free contract analysis
            </p>
          </div>
